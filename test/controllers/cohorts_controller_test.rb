...
class CohortsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create cohort" do
    assert_difference('Cohort.count') do
      post cohorts_url, params: { cohort: { created_at: @cohort.created_at, end_date: @cohort.end_date, instructor_id: @cohort.instructor_id, start_date: @cohort.start_date, title: @cohort.title, updated_at: @cohort.updated_at } }
    end
  ...
  test "should update cohort" do
    patch cohort_url(@cohort), params: { cohort: { created_at: @cohort.created_at, end_date: @cohort.end_date, instructor_id: @cohort.instructor_id, start_date: @cohort.start_date, title: @cohort.title, updated_at: @cohort.updated_at } }
